...
Лек 2.2. [Вступ до GitHub: теоретична частина](https://github.com/asu-in-ua/atpv/blob/main/vercontrol/github/teor.md)

Лаб 1. [Основи роботи з MarkDown та GitHub](Лабор/v2lab1.md)

Лаб 2. [Основи роботи з Git, та віддаленим GitHub](Лабор/v2lab2.md)

Курсова. Створення власного репозиторію для курсової роботи. Вибір теми. Створення опису рішення. 

### Тиждень 3-4 (16.02 - 1.03)

Лек 3.1. [Вступ до систем керування версіями та Git: теоретична частина](https://github.com/asu-in-ua/atpv/blob/main/vercontrol/git/teor.md)
...
Лаб 3. [Основи роботи з Node-RED](Лабор/v2lab3.md)

Лаб 4. [Основи роботи з користувацьким інтерфейсом в Node-RED](Лабор/v2lab4.md)
...
Лаб 5. [Основи роботи з Raspberry PI](Лабор/v2lab5.md)

Лек 6. Хмарні сервіси, віртуальні машини.

Лаб 6. [Основи роботи з віртуальними машинами](Лабор/v2lab6.md)
