...
- [Методичні рекомендації до виконання курсової роботи](v2kursmetod.md)
- [Варіанти 2026](варіанти2026.md)
...
- [Методичні рекомендації до виконання курсового проекту (командна робота)](kursmetod.md)
- [Приклад виконання розділів курсового проекту (командна робота)](kursexample.md)
