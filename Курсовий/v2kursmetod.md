...
- класичні завдання 30 шт, що включають:
  ...
  - збір даних з веденням архіву на землі
...
Основні проведені роботи

1. створення власного репозиторію для курсової роботи, створення опису - лабораторна 1 (git+GitHub, Markdown)
2. створення проєкту для шлюза: відображення плинних вимірювальних даних на Dashboard - лабораторна 2 (Node-RED + Dash 2 + git)
3. апаратне забезпечення - вибір датчика, лабораторна 3 (Raspberry PI) 
4. підготовка віртуального середовища для тестування - лабораторна 4 (віртуальна машина Debian, контейнери)
5. render - лабораторна 5 (HTTP API)
6. відправка даних реального часу на смартфон, mqtt Panel лабораторна 6 (MQTT)
7. запис в локальну базу даних - системний журнал, дані датчиків,  SQL лабораторна, обробка статистичних даних та відправка на віддалений SQL 7 (SQL)
8. сповіщення через Discord або Telegram  
