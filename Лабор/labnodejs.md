...
Мета лабораторної роботи навчитися створювати застосунки для середовища виконання Node.js та розгортати їх в хмарному середовищі.    
...
### 7. Створення клієнту з використанням модулю http
...
### 15. Створення обробника для запиту даних від серверу 
