...
# 15. Використання хмарних сервісів для IoT.

## 15.1. Про хмарні обчислення
...
рис.15.1. Приклади використання хмарних обчислень.
...
рис.15.2. Стек з віртуальною машиною та гіпервізором. 
...
Гіпервізори можуть працювати як поверх ОС, у цьому випадку кажуть про "хостову ОС" так і як операційна система. Розглянемо це на прикладах платформ віртуалізації XEN та KVM (рис.15.3) XEN - це гіпервізор, який працює поверх заліза. KVM - гіпервізор, який працює як служба ОС, дає можливість працювати як віртуальним машинам так і застосункам безпосередньо в цій же ОС.

![](cloudmedia/xen.jpg)

рис.15.3. Приклад роботи гіпервізорів поверх заліза або на рівні ОС.
...
За допомогою контейнерів, замість віртуалізації базового комп'ютера, як віртуальної машини (VM), віртуалізована тільки сама ОС (рис.15.4).
...
Контейнерні технології дуже гнучкі і можуть використовувати різноманітні комбінації стеків. На рис.15.5 показаний приклад розгортання контейнерів RHEL.

![](cloudmedia/redhat.png)

рис.15.5. Можливості розгортання контейнерів RHEL.
...
Таблиця 15.1. Порівняння віртуальних машин та контейнерів
...
рис.15.6. Моделі топологій хмар
...
Рис.15.7. Різні моделі надання хмарних сервісів.
...
рис.15.8. Приклад віртуалізації IaaS: VMware vSphere.
