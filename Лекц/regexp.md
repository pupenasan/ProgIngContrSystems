...
let result = str.match(/давай/gi); //призначення прапорців див нижче
...
## Жадібні та ліниві квантифікатои
...
## Випереджаючі і ретроспективні перевірки

https://learn.javascript.ru/regexp-lookahead-lookbehind

## Методи RegExp і String
